...
<div class="page-header">
	<!-- BEGIN HEADER TOP -->
	@include('partials-task.headerTop')
	<!-- END HEADER TOP -->
	<!-- BEGIN HEADER MENU -->
	@include('partials-task.headermenu')
	<!-- END HEADER MENU -->
...
<div class="page-container">
	...
	<div class="page-head">
		<div class="container">
			<!-- BEGIN PAGE TITLE -->
			@include('taskstodo.partials.pagetitle')
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
			@include('partials-task.toolbar')
...
<!-- END PAGE CONTAINER -->
<!-- BEGIN PRE-FOOTER -->
@include('partials-task.prefooter')
<!-- END PRE-FOOTER -->
<!-- BEGIN FOOTER -->
@include('partials-task.footer')
<!-- END FOOTER -->
